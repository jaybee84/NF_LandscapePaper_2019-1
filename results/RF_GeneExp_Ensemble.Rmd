...
print("Median F1 scores of ensemble")
rowMedians(as.matrix(perf_new[,c(2:ncol(perf_new))]), na.rm=TRUE)
...
print("Median F1 scores of final ensemble:")
rowMedians(as.matrix(perf_final[,c(3:ncol(perf_final))]), na.rm=TRUE)
```
